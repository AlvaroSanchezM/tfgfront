...
public class TFG {
    ...
    public TFG(@Email String alumno, @Email String tutor, @NotEmpty String titulo, String resumen, Estado estado,
            URI memoria, @PositiveOrZero @DecimalMax("10.0") Double calificacion, Boolean matriculaHonor,
            Sesion sesion) {
        this.alumno = alumno;
        this.tutor = tutor;
        this.titulo = titulo;
